...
def intervalo(infile,notes):
    ...
    for n in tudo:
        ...
        if n-tudo[cont+1]==3 or n-tudo[cont+1]==-3:
            arq.write("terceira menor\n")
        if n-tudo[cont+1]==4 or n-tudo[cont+1]==-4:
...
if __name__ == "__main__":
    ...
    for l in linhas:
        m,n = l.split("\n")
        print(m)
        args.infile = 'musicas_tristes/'+m+'.wav'
        notes = audio_to_midi_melodia('musicas_tristes/'+m+'.wav', args.outfile, args.bpm,
